...
# 1i is as 1h but it uses an offline version of i-vector extraction on L79
# instead of online i-vectors as in 1h.

# local/chain/compare_wer.sh --online exp/chain/tdnn1h_sp exp/chain/tdnn1i_sp
# System                tdnn1h_sp tdnn1i_sp
#WER dev_clean_2 (tgsmall)      12.00     11.84
#             [online:]         12.01     11.85
#WER dev_clean_2 (tglarge)       8.42      8.22
#             [online:]          8.51      8.42
# Final train prob        -0.0482   -0.0473
# Final valid prob        -0.0769   -0.0766
# Final train prob (xent)   -1.1748   -1.1710
# Final valid prob (xent)   -1.3838   -1.3846
# Num-params                 5195504   5198592
...
# run those things.
local/nnet3/run_ivector_common_offline.sh --stage $stage \
                                  --train-set $train_set \
                                  --gmm $gmm \
