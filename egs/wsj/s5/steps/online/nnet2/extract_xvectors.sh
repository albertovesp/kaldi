...
#               2019  Johns Hopkins University (Author: Desh Raj)
# Apache 2.0.
...
# is analogous to steps/online/nnet2/extract_ivectors.sh: it creates archives
# of x-vectors to be used for speaker adaptation in ASR recipes (see for e.g.
# egs/wsj/local/chain/run_tdnn.sh)
...
if [ $stage -le 5 ]; then
  echo "$0: combining x-vectors across jobs"
