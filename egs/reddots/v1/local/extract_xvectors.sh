...
if [ $stage -le 2 ]; then
  echo "$0: copy FV type xvectors to FM type"
  copy-vector --binary=false scp:$dir/xvector.scp ark,t:- | \
    copy-matrix ark,t:- ark,scp:$dir/xvector_mat.ark,$dir/xvector_mat.scp
fi
#if [ $stage -le 2 ]; then
