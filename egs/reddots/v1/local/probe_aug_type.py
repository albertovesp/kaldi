...
def main():
  ...
  labels, num_classes, label_encoder = get_int_labels(args.vector_scp_file)
  ...
  fout.write('{}\n'.format(multilabel_confusion_matrix(y_true, y_pred)))
  fout.write(np.array_str(label_encoder.inverse_transform([0,1,2,3])))
  fout.write('--------------------------------\n')
