...
# Set up the features
feats="ark:apply-cmvn-sliding --norm-vars=false --center=true --cmn-window=300 scp:${sdata}/feats.scp ark:- | select-voiced-frames ark:- scp,s,cs:${sdata}/vad.scp ark:- |"
...
if [ $stage -le 2 ]; then
  if [ ! -z "$ali_or_decode_dir" ]; then
    $cmd JOB=1:$nj ${dir}/log/extract.JOB.log \
      ...
      "$nnet" "$feat" ark,scp:${dir}/ivectors_spk.JOB.ark,${dir}/xvector.JOB.scp \| \
