...
# run_tdnn_1c is the same as run_tdnn_1b, except that it uses
# an offline version of the i-vectors.
...
if [ $stage -le 16 ]; then
  ...
  # speed-perturbed data (local/nnet3/run_ivector_common_offline.sh made them),
  # so use those.
